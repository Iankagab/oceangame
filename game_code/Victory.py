...
import pygame
from Const import WIN_WIDHT, WIN_HEIGHT, COLOR_BLACK, COLOR_GREEN
...
class Victory:
    ...
    def display(self):
        ...
        won_text = font.render('Parabéns, você ganhou!', True, (255, 0, 0))  
        text_rect = won_text.get_rect(center=(WIN_WIDHT // 2, WIN_HEIGHT // 2)) 
        self.window.blit(won_text, text_rect)
